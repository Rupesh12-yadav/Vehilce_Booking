          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-4">
                Your trusted partner for premium vehicle rentals. Experience seamless booking and exceptional service.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/vehicles" className="text-gray-400 hover:text-primary-400 transition-colors duration-200 text-sm">
                    Browse Vehicles
                  </Link>
                </li>
                <li>
                  <Link to="/my-bookings" className="text-gray-400 hover:text-primary-400 transition-colors duration-200 text-sm">
                    My Bookings
                  </Link>
                </li>
                <li>
